...
def test_get_behavior(mock_project):
    ...
    settings = {
        "behavior": {
            "Walking": {"window_size": 5, "balance_labels": True, "symmetric_behavior": False}
        }
    }
...
def test_update_behavior(mock_project):
    ...
    new_settings = {"window_size": 10, "balance_labels": False, "symmetric_behavior": True}
...
def test_save_behavior(mock_project):
    ...
    new_behavior_settings = {"window_size": 10, "balance_labels": False, "symmetric_behavior": True}
