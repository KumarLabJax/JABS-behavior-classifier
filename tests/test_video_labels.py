...
class TestVideoLabels(unittest.TestCase):
    ...
    def test_getting_new_track(self):
        ...
        for i in range(0, 99):
            self.assertEqual(track.get_frame_label(i), track.Label.MINIMAL)
    ...
    def test_load_from_dict(self):
        ...
        self.assertEqual(track.get_frame_label(24), track.Label.MINIMAL)
        self.assertEqual(track.get_frame_label(51), track.Label.MINIMAL)
