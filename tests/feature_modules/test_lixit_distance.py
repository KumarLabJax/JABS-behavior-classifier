...
import src.feature_extraction.landmark_features.lixit as lixit
...
class TestCornerFeatures(TestFeatureBase):
    ...
    def setUpClass(cls) -> None:
        ...
        cls.lixit_distance = lixit.DistanceToLixit(cls._pose_est_v5,
                                                   pixel_scale)
    ...
    def test_dimensions(self):
        ...
        for i in range(self._pose_est_v5.num_identities):
            ...
            self.assertEqual(distances.shape,
    ...
    def test_computation(self):
        ...
        expected = np.asarray([10.44161892, 10.51272678, 10.60188961,
                               10.67293644, 10.7262249, 10.70890999,
                               10.70890999, 10.7802515, 10.7802515,
                               10.90649891], dtype=np.float32)
