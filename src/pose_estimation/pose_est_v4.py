...
class PoseEstimationV4(PoseEstimation):
    ...
    def __init__(self, file_path: Path,
        ...
        if self._num_identities > 0:
            ...
            points_tmp[np.where(id_mask == 0)[0],
                instance_embed_id[id_mask == 0] - 1, :, :] = all_points[id_mask == 0, :, :]
            ...
            confidence_by_id_tmp[np.where(id_mask == 0)[0],
                instance_embed_id[id_mask == 0] - 1, :] = all_confidence[id_mask == 0, :]
    ...
    def get_points(self, frame_index: int, identity: int,
        ...
        """
        print("point shape:",self._points.shape)
