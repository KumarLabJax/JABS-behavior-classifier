...
class PredictionManager:
    ...
    @classmethod
    def write_predictions(cls, behavior: str, output_path: Path, predictions, probabilities, poses, classifier):
        """
    ...
    def load_predictions(self, video: str, behavior: str):
        ...
        nident = self._project._metadata['video_files'][video]['identities']
        ...
        try:
            with h5py.File(path, 'r') as h5:
                ...
                if to_safe_name(behavior) not in prediction_group:
                    ...
                    raise IOError(f'Behavior {to_safe_name(behavior)} not in prediction file.')
