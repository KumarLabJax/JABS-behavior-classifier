...
![Example directory](images/exampledir.png)
...
![Classifier Controls](images/classifier_controls.png)
...
![Label Viz](images/label_viz.png)
...
![Track Overlay](images/track_overlay.png)

**Pose Overlay Example:**  

![Pose Overlay](images/pose_overlay.png)
...
![Selecting Frames](images/selecting_frames.png)
...
![Identity Gaps](images/identity_gaps.png)
