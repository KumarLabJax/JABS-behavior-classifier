...
_STAGE_REGISTRY: dict[str, type[PostprocessingStage]] = {
    BoutDurationFilterStage.__name__: BoutDurationFilterStage,
    GapInterpolationStage.__name__: GapInterpolationStage,
    BoutStitchingStage.__name__: BoutStitchingStage,
}
