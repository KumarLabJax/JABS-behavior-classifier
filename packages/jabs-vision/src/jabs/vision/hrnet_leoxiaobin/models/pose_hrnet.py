...
class PoseHighResolutionNet(nn.Module):
    def __init__(self, cfg, **kwargs):
        ...
        self.conv2 = nn.Conv2d(
            64, 64, kernel_size=3, stride=2, padding=1, padding_mode=self.padding_mode, bias=False
        )
    ...
    def _make_layer(self, block, planes, blocks, stride=1):
        ...
        layers = []
        layers.append(
            block(self.inplanes, planes, stride, downsample, padding_mode=self.padding_mode)
        )
