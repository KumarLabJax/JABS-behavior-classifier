...
# MMPose top-down keypoint config: pairs with detector configs in this folder
# when running the full detect-then-pose pipeline.
max_epochs = 50
val_interval = 5
base_lr = 5e-4
input_size = (256, 256)
...
# Same top-down head/training recipe as ResNet config, but with EfficientNetV2-S.
model = {
