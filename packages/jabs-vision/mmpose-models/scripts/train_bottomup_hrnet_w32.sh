#!/bin/bash
#
#SBATCH --job-name=train-bottomup-hrnet-w32
...
# "moves" into `runs/bottomup_hrnet_w32/${SLURM_JOB_ID}/` (same-filesystem required).
RUNS_JOB_DIR="runs/bottomup_hrnet_w32/${SLURM_JOB_ID}"
