#!/bin/bash
#
#SBATCH --job-name=train-topdown-efficientnetv2-s
...
# "moves" into `runs/topdown_efficientnetv2_s/${SLURM_JOB_ID}/` (same-filesystem required).
RUNS_JOB_DIR="runs/topdown_efficientnetv2_s/${SLURM_JOB_ID}"
