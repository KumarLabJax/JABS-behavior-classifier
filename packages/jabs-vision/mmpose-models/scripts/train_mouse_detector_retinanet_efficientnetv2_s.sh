#!/bin/bash
#
#SBATCH --job-name=train-mouse-detector-retinanet-efficientnetv2-s
...
# "moves" into `runs/mouse_detector_retinanet_efficientnetv2_s/${SLURM_JOB_ID}/` (same-filesystem required).
RUNS_JOB_DIR="runs/mouse_detector_retinanet_efficientnetv2_s/${SLURM_JOB_ID}"
