#!/bin/bash
#
#SBATCH --job-name=train-mouse-detector-retinanet
...
# "moves" into `runs/mouse_detector_retinanet/${SLURM_JOB_ID}/` (same-filesystem required).
RUNS_JOB_DIR="runs/mouse_detector_retinanet/${SLURM_JOB_ID}"
